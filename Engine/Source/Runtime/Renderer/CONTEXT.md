...
| **ForwardRenderer** | Current single-material forward PBR renderer. Owns asynchronous pipeline and logical frame/view/material constant-buffer refs, consumes Scene draw packets, and renders direct directional light with a constant metallic-roughness material. |
