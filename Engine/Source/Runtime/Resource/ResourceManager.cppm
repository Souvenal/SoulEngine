  ...
  public:
    ...
    RequestBottomLevelAccelerationStructureRef(const ResourceRef<ResourceMesh>&               MeshRef,
        ...
        return AcquireResourceRef(
            m_Context, SubmitBottomLevelAccelerationStructureRequest(m_Context, MeshRef.GetHandle(), Request));
    }
    ...
    [[nodiscard]] auto RequestTopLevelAccelerationStructureRef(StringView                                  ScopeKey,
        ...
        return AcquireResourceRef(m_Context, SubmitTopLevelAccelerationStructureRequest(m_Context, ScopeKey, Desc));
    }
